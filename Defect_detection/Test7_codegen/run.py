...
from model import DefectModel, DecoderClassifier
cpu_cont = multiprocessing.cpu_count()
from transformers import (WEIGHTS_NAME, AdamW, get_linear_schedule_with_warmup,
                          AutoTokenizer,LlamaConfig, LlamaModel, CodeGenConfig, CodeGenModel
                          )
...
def convert_examples_to_features(js,tokenizer,args):
    ...
    source_ids = tokenizer.encode(js['func'].split("</s>")[0], max_length=args.block_size, padding='max_length',
                                  truncation=True)
